...
export const addressConfig: Record<SupportedChainId, Config> = {
  ...
  [SupportedChainId.celo]: {
    ...
    [SupportedDex.UniswapNew]: {
      factoryAddress: '0x0C7F01223caA3011ff59Ae36a707Da5c78D6Ae38',
      depositGuard: {
  ...
  [SupportedChainId.robinhood]: {
    [SupportedDex.KittyPunch]: {
      ...
      vaultDeployerAddress: '0x26ac5f256e5B42fD288D3EF9FbF80f5E0070bbEe',
      isAlgebra: false,
    },
  },
...
export const MULTICALL_ADDRESSES: Partial<Record<SupportedChainId, string>> = {
  ...
  [SupportedChainId.robinhood]: '0xb978c58fa57BBd3951d053EDeA493E5C3ff1a415',
